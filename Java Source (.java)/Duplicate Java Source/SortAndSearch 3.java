 ...
 *  @version Last Modified June 29, 2013
 */
import java.util.*;
...
class SortAndSearch
{
   ...
   */
  static int binary (int [] a, int key, int fromIndex, int toIndex)
  {
      int middle;
      do 
      {
  ...
  public static void main (String[] args)
  {
    ...
    do
    {
        ...
        itemLoc = binary (list, item, 0, ACTUAL_SIZE - 1);
        if (itemLoc >= 0)
            System.out.println ("Found " + item + " at location " + itemLoc);
        else
            System.out.println 
