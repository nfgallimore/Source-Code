...
- (void) tableView:(UITableView *)tableView moveRowAtIndexPath:(NSIndexPath *)sourceIndexPath toIndexPath:(NSIndexPath *)destinationIndexPath
{
    ...
    NSString *fruitItem = [self.fruit objectAtIndex:sourceIndexPath.row];
    
    [self.fruit removeObjectAtIndex:sourceIndexPath.row];
    [self.fruit insertObject:fruitItem atIndex:destinationIndexPath.row];
}
